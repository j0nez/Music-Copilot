...
- **Current Focus**: Phase F — ToolBridge implementation (Step 1 done: `shared/tools.py` with Tool dataclass + ToolRegistry). Next: Step 2 — add `tool_calls` to LLMResponse.
